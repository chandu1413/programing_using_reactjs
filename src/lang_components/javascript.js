...
import {UnderHeading,Heading1,Heading3,Box} from "./Javascript.Style"
  ...
  return (
    ...
    <>
        ...
        <div>
          ...
          <Heading3 className='head3'>History</Heading3>
          <hr/>
          <UnderHeading className='heading4'>Creation at Netscape</UnderHeading>
          ...
          <UnderHeading>Adoption by Microsoft</UnderHeading>
          ...
          <UnderHeading className='heading4'>The rise of JScript</UnderHeading>
          ...
          <Heading3 >Hello World using Javascript</Heading3>
