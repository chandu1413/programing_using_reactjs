...
import './Java.css'
import { UnderHeading,Heading ,Heading3} from './Java.Style'
...
const Java = () => {
  ...
  return (
    ...
    <img className='javaimg'  src='https://www.geeksforgeeks.org/wp-content/uploads/Java.png' alt='java' />
  <div className='container-fluid container'>
    <Heading >Java (programming language)</Heading>
    <hr/><br/>
    ...
    <br/>
    <Heading3>History of Java</Heading3>
    <br/>
    ...
    <div className='row'>
      <div className='col-md-9'>
        ...
        <ul>
          ...
          <UnderHeading>Why Java was named as "Oak"?</UnderHeading>
    ...
    <Heading3>Features of Java</Heading3> 
    ...
    <Heading3>Syntax</Heading3>
      ...
      <br/>
    <Heading3>First Java Program | Hello World Example</Heading3>
    ...
    <div className='col-md-6 py-4 j-exp-pro container'>
      <pre className='j-program'>
    ...
    <br/>
    <p className='op'><strong>Output:</strong> Hello Java</p>
  </div>
